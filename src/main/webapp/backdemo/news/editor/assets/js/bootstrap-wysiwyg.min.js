(function (b) {
    var a = function (e) {
        ...
        form.append("editorImage", e);
        var xhr = new XMLHttpRequest();
        xhr.open("post", "../../uploadMarkdownImage.mvc", false);
        xhr.send(form);
        pa = xhr.responseText;
    ...
    b.fn.wysiwyg = function (k) {
        var l = this, h, q, d, p = function () {
            ...
            p();
           /* $("#editor1").find("img:nth-of-type("+$("#editor1 img").length+")").attr("src","/logistics/"+pa);
            $("#editor1").find("img:nth-of-type("+$("#editor1 img").length+")").attr("width","auto");*/

           $('#editor1').find('img:last').attr("src","/logistics/"+pa);
            $('#editor1').find('img:last').attr("width","auto");
