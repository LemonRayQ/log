...
(function (a, b) {
    a.fn.ace_wysiwyg = function (c, h) {
        ...
        var g = {
            font: {
                values: ["Arial", "Courier", "Comic Sans MS", "Helvetica", "Open Sans", "Tahoma", "Verdana","宋体","楷体","微软"],
                icon: "icon-font",
                title: "字体"
            },
            fontSize: {values: {5: "大", 3: "正常", 1: "小"}, icon: "icon-text-height", title: "字体大小"},
            bold: {icon: "icon-bold", title: "加粗 (Ctrl/Cmd+B)"},
            italic: {icon: "icon-italic", title: "倾斜 (Ctrl/Cmd+I)"},
            strikethrough: {icon: "icon-strikethrough", title: "删除线"},
            underline: {icon: "icon-underline", title: "下划线"},
            insertunorderedlist: {icon: "icon-list-ul", title: "项目符号"},
            insertorderedlist: {icon: "icon-list-ol", title: "数字列表"},
            outdent: {icon: "icon-indent-left", title: "取消标号 (Shift+Tab)"},
            indent: {icon: "icon-indent-right", title: "缩进 (Tab)"},
            justifyleft: {icon: "icon-align-left", title: "靠左 (Ctrl/Cmd+L)"},
            justifycenter: {icon: "icon-align-center", title: "居中 (Ctrl/Cmd+E)"},
            justifyright: {icon: "icon-align-right", title: "靠右 (Ctrl/Cmd+R)"},
            justifyfull: {icon: "icon-align-justify", title: "两端对齐 (Ctrl/Cmd+J)"},
            createLink: {
                icon: "icon-link",
                title: "超链接",
                button_text: "添加",
            ...
            unlink: {icon: "icon-unlink", title: "移除超链接"},
            insertImage: {
                icon: "icon-picture",
                title: "插入图片",
            ...
            foreColor: {values: e, title: "改变颜色"},
            backColor: {values: e, title: "改变背景颜色"},
            undo: {icon: "icon-undo", title: "撤销 (Ctrl/Cmd+Z)"},
            redo: {icon: "icon-repeat", title: "返回 (Ctrl/Cmd+Y)"},
