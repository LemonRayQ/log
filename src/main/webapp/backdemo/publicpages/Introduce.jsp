    ...
    <div class="container-fluid">
        ...
        <div class="content-right">
            <div class="header">
                ...
                <div class="new-body">
                    <form action="../../updateIntroduce.mvc" method="POST" role="form" id="form1">
                        <!-- 文本编辑器 -->
                        <div class="text-area">
                            <input type="hidden" name="title" value="基建概况">
                            <input type="hidden" name="content" id="content">
                            <input type="hidden" name="deptId" value="2">
                            <input type="hidden" name="classId" value="15">
                            <div class="wysiwyg-editor" id="editor1">${introduce.content}
                            </div>
                            <div class="hr hr-double dotted"></div>
                        </div>
                    </form>
                    <div class="show-btn">
                        <button class="btn btn-success" onclick="updateIntroduce()">修改</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function updateIntroduce() {
        if($("#editor1").html() === ""){
            ...
            $.ajax({
                url:"<%=basePath%>updateIntroduce.mvc",
                type:"post",
