...
<div class="container-fluid">
    ...
    <div class="content-right">
        <div class="header">
            ...
            <c:if test="${superFlag!=null}">
                <div class="addworklabel">
                    <div class="addlabel">
                        <form action="./insertDepartment" method="POST" role="form">
                            <div class="form-group">
                                <label for="newOffice">添加新的科室</label>
                                <input type="text" class="form-control" id="newOffice" name="newName"
                                       placeholder="新的科室名称">
                            </div>
                    ...
                    <div class="worklabel">
                        <form action="../../changeDepart" method="POST" role="form" class="form-inline"
                              id="changeForm">
                            ...
                            <div class="modal-dialog" style="left:5%;" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-success btn-sm" style="width:60px"
                                                onclick="changeDepart()">确认
                                        </button>
        ...
        <div class="new-body">
            <form action="../../updateOfficeDuty" method="POST" role="form" id="form1">
                <div class="form-group">
...
<script>
    function selectDuty(obj) {
        ...
        $.ajax({
            url: "<%=basePath%>selectOfficeDutywithId?deptId=" + dept_id,
            type: "post",
            success: function () {
    ...
    function changeDepart() {
        ...
        $.ajax({
            url: "<%=basePath%>changeDepart?changeName=" + changeName,
            type: "post",
