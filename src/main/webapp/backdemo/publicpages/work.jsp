...
<div class="container-fluid">
    ...
    <div class="content-right">
        <div class="header">
            ...
            <div class="new-body">
                <form action="../../insertNews.mvc" method="POST" id="form1" role="form" onsubmit="return addContent()"
            ...
            <div class="show-news">
                <form class="navbar-form" action="../../selectWorkWithName.mvc">
                    <div class="form-group">
...
<script>
    ...
    function selectWithDept(value) {
        if (value.value > 0) {
            $.ajax({
                url: "<%=basePath%>selectWorkWithDept.mvc?deptId=" + value.value,
                type: "post",
                success: function (data) {
                    window.location.reload();
                },
